...
#Instancio un nuevo objeto de de la clase binarytree y le asigno la referencia a la variable tree

#tree = BinaryTree()

#Superheroes insertados en el arbol
#for personaje in super_heroes:
#    is_hero='villano' not in personaje
#    personaje['is_hero'] = is_hero
#    tree.insert_node(personaje['nombre'], personaje)



# tree.inorden_villanos() #Comprueba que muestra los Villanos en orden alfabetico

# tree.inorden_superheros_start_with('C') #lista los Superherores que comienzan con C

#print('cantidad de superherores:')
#print(tree.contar_super_heroes())

#pos = tree.search("Dortor Strange")
#if pos:
#    pos.value = "Doctor Strange"  # Corrige el nombre
#    print(f"Nombre corregido: {pos.value}")


#tree.inorden_superheroes_descendentes()
...
for personaje in super_heroes:
        is_hero='villano' not in personaje
        personaje['is_hero'] = is_hero
        heroes_tree.insert_node(personaje['nombre'], personaje)

for personaje in super_heroes:
        is_hero = 'villano' in personaje
        personaje["is_hero"] != is_hero
        villanos_tree.insert_node(personaje['nombre'], personaje)


print("La cantidad de nodos en el arbol de superheroes es: ", heroes_tree.contar_super_heroes())
print("La cantidad de nodos en el arbol de villanos es: ", villanos_tree.contar_villanos()) 
